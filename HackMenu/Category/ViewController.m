...
- (IBAction)showWaiting:(id)sender
{
    ...
    [alert showWaiting:self title:@"等待..."
...
- (IBAction)showQuestion:(id)sender
{
    ...
    [alert showQuestion:self title:@"Question?不能" subTitle:kSubtitle closeButtonTitle:@"Dismiss" duration:0.0f];
}
//可以 显示开关
- (IBAction)showSwitch:(id)sender {
    ...
    [alert addSwitchViewWithLabel:@"开关Don't show again".uppercaseString];
...
- (IBAction)showWithButtonCustom:(id)sender
{
    ...
    [alert addButton:@"Second Button可以" actionBlock:^(void) {
        NSLog(@"Second button tapped");
    }];
