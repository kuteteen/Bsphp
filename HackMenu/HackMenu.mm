...
@interface HackMenu : NSObject

@end

@implementation HackMenu
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.mufeng.HackMenu.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.mufeng.HackMenu.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
